    ...
    <header class="main-header">
      ...
      <a href="" class="logo">
        ...
        <span class="logo-lg"><b>Toyota</b>DSCS</span>
      </a>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-body">
                  <div class="row">
                    <div class="col-xs-4 text-center">
                      <a href="#"><i class="fa fa-spin fa-gear"></i>Settings</a>
                    </div>
                    <div class="col-xs-4 text-center">
                      <!--<a href="#">Sales</a>-->
                    </div>
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a class="btn btn-default btn-flat" id="loggout" onclick="logout()">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
