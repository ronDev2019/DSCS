<?php
	...
	if(isset($_POST['submit'])){
		...
		$insert = $func->updateProspect($pid, $fname, $mname, $lname, $contact, $brgy, $city, $province, $model, $color, $contract_code, $activity_code, $category, $remarks, $active, $user, $date_added, $user, $date_added);

		if($insert == true){

			$insActivity = $func->updateActivity($pid);
