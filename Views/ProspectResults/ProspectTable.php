<?php
  ...
  error_reporting(0);
	...
	if(isset($_POST['filter'])){
		...
		$agentid = $func->sec($_POST['AgentId']);
		...
		?>
                ...
                <!-- Prospect Table -->
                  <table id="prosList" class="table table-bordered table-striped table-hovered">
                    <thead>
                      <tr>
                        <th> No. </th>
                        <th> Customer </th>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <button class="btn btn-xs btn-success view" onclick="view(<?= $val->ProspectId ?>)" data-toggle="tooltip" title="View Details"> View Details <i class="fa fa-eye"> </i> </button> 
                      </td>
                    </tr>
